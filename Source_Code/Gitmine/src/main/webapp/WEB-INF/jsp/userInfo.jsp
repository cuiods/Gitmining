...
<body>
	...
	<div class="about-header-banner">
		<div class="container">
			<div class="home">
					<a href="../../html/index.html"><span class="glyphicon glyphicon-home"></span></a>
			</div>
			<div class="header-top">
				...
				<div class="top-menu">
					...
					<nav class="cl-effect-13">
						...
						<li><a href="../../html/gallery.html">UserInfo</a></li>
						<li><a class="active" href="../../html/index.html">News</a></li>
						<li><a href="../../html/typography.html">Typo</a></li>
			...
			<div class="col-md-8 single-page-left">
				...
				<div class="row related-posts">
					...
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="../../html/single.html" class="thumbnail">
							<img src="../../images/img2.jpg" alt=""/>
						</a>
						<h5><a href="../../html/single.html">Lorem Ipsum is simply</a></h5>
					</div>	
					<div class="col-xs-6 col-md-3 related-grids">
						<a href="../../html/single.html" class="thumbnail">
				...
				<div class="response">
					...
					<div class="media response-info">
						...
						<div class="media-body response-text-right">
							...
							<ul>
								<li>June 21, 2015</li>
								<li><a href="../../html/single.html">Reply</a></li>
							</ul>
							<div class="media response-info">
								<div class="media-left response-text-left">
									<a href="#">
			...
			<div class="col-md-4 single-page-right">
				<div class="category">
					...
					<div class="list-group">
						<a href="../../html/single.html" class="list-group-item">Cras justo odio</a>
						<a href="../../html/single.html" class="list-group-item">Dapibus ac facilisis in</a>
						<a href="../../html/single.html" class="list-group-item">Morbi leo risus</a>
						<a href="../../html/single.html" class="list-group-item">Porta ac consectetur ac</a>
						<a href="../../html/single.html" class="list-group-item">Vestibulum at eros</a>
						<a href="../../html/single.html" class="list-group-item">Cras justo odio</a>
						<a href="../../html/single.html" class="list-group-item">Cras justo odio</a>
						<a href="../../html/single.html" class="list-group-item">Cras justo odio</a>
					</div>
				...
				<div class="recent-posts">
					...
					<div class="recent-posts-info">
						<div class="posts-left sngl-img">
							<a href="../../html/single.html"> <img src="../../images/img16.jpg" alt=""/> </a>
						</div>
						<div class="posts-right">
							<lable>June 5, 2015</lable>
							<h5><a href="../../html/single.html">FINIBUS BONORUM MALORUM </a></h5>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing incididunt.</p>
							<a href="../../html/single.html" class="btn btn-primary hvr-rectangle-in">Read More</a>
						</div>
						<div class="clearfix"> </div>
					</div>	
					<div class="recent-posts-info">
						<div class="posts-left sngl-img">
							<a href="../../html/single.html"> <img src="../../images/img17.jpg" alt=""/></a>
						</div>
						<div class="posts-right">
				...
				<div class="comments">
					...
					<div class="comments-info">
						<div class="cmnt-icon-left">
							<a href="../../html/single.html"><img src="../../images/icon1.png" alt=""/></a>
						</div>
						<div class="cmnt-icon-right">
							<p>June 1, 2015</p>
							<p><a href="../../html/single.html">Admin</a></p>
						</div>
						<div class="clearfix"> </div>
