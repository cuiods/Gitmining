...
public class ItemIssuePOReader implements ItemService {

	public ItemIssuePOReader() {
	}
	private String url_string;
	public ItemIssuePOReader(String fullname,String sha) {
	...
	public ItemIssuePOReader(String owner,String name,String sha) {
